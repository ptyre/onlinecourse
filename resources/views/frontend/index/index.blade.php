				...
				<div class="col-lg-6 nopadding">
					...
					<div class="search_section d-flex flex-column align-items-center justify-content-center">
						...
						<div class="search_content text-center">
							<h1 class="search_title">Register</h1>
							<form id="register_form" class="search_form" action="{{route('register2')}}" method="POST" >
							@csrf
								<input type="hidden" name="role_id" value="3">
								<input id="name" class="input_field search_form_name" type="text" name="name" placeholder="Full Name" required="required" data-error="Course name is required.">
								<input id="email" class="input_field search_form_category" type="email" name="email" placeholder="Email">
								<input id="password" class="input_field search_form_degree" type="password" name="password" placeholder="Password">
								<button id="submit_button" type="submit" class="search_submit_button trans_200" value="Submit">Register</button>
							</form>
						</div> 
					</div>
