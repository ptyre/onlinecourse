				...
				<div class="col-lg-8">
					...
					<div class="news_post_container">
						...
						<div class="news_post">
							...
							@else
								<div class="news_post_text">
                            		<p>please <a href="{{route('front.course.post' ,[ $lesson->course->slug])}}">go back</a> buy the course</p>
								</div>
							@endif
							@if ($previus_lesson)
								<p><a class="btn btn-success" href="{{route('front.lesson.post', [$previus_lesson->course_id ,$previus_lesson->slug])}}"> << {{$previus_lesson->title}}</a></p>
							@endif
							@if ($next_lesson)
								<p><a class="btn btn-success" href="{{route('front.lesson.post', [$next_lesson->course_id , $next_lesson->slug])}}"> >> {{$next_lesson->title}}</a></p>
							@endif
							...
							@if ($test_exists)
								...
								<form action="{{ route('front.lesson.test', [$lesson->slug]) }}" method="post">
					...
					<div class="sidebar">
						...
						<div class="sidebar_section">
							<div class="sidebar_section_title">
								<h3>{{$lesson->course->title}} Menu</h3>
							</div>
							<ul class="sidebar_list">
								<div class="tags d-flex flex-row flex-wrap">
									@foreach($lesson->course->publishedLessons as $l)
									<div class="tag">
										<a href="{{route('front.lesson.post' , [$l->course_id,$l->slug])}}">{{$l->title}}</a>
									</div>	
									@endforeach
								</div>
							</ul>
