        ...
        @if (Auth::user()->isAdmin())
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('teachers[]', $teachers, old('teachers'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-teachers' , 'required' => '']) !!}
            ...
            @else
            {!! Form::hidden('teachers', old('teachers'), ['class' => 'form-control', 'placeholder' => '', 'required' => '', 'value' => 'Auth::id()']) !!}
            @endif
